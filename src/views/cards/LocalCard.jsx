...
export default function LocalCard({ recipe, id }) {
  ...
  return (
    <div className="mx-3 my-4 col-span-1 hover:scale-105 transition duration-300 p-2 object-cover border-2 dark:border-white rounded-lg dark:bg-black dark:text-white shadow-2xl shadow-yellow-200 hover:shadow-yellow-500 dark:shadow-gray-700 bg-orange-500 dark:hover:shadow-gray-200">
      <div>
      ...
      <div>
        ...
        <Modal
          ...
          // style={customStyles}
          className="dark:bg-black dark:text-white md:w-[600px] w-[300px] h-[250px] md:h-[200px] m-auto mt-52 p-10 bg-orange-100 lobster-font"
